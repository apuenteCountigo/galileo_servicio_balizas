...
public interface BalizasRepository extends PagingAndSortingRepository<Balizas, Long> {
	...
	public Page<Balizas> buscarBalizas(int idEstadoBaliza,int unidad,String clave, String marca, String modelo,String numSeries,String compania,@DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime fechaInicio, @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime fechaFin, Pageable p);
